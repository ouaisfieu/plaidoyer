...
/* ============================================================
   DÉFINITION DÉCLARATIVE DES OUTILS DE L'ATELIER
   type "zones"  : liste de textareas
   type "special": rendu dédié dans atelier.js
   ============================================================ */
const OUTILS = [
  // ---------- VOIR ----------
  { id: "domino", phase: "voir", nom: "Domino du changement",
    aide: "Un basculement en entraîne d'autres. Décris ta vision, ce qui la rend possible et ce qui la freine.",
    type: "zones", champs: [
      ["vision", "Vision : le changement final souhaité"],
      ["ressources", "Ressources et forces qui rendent le basculement possible"],
      ["obstacles", "Obstacles et freins à lever"]] },
  { id: "profil", phase: "voir", nom: "Quel est mon profil ?",
    aide: "Se situer soi-même avant d'agir : ton rôle dans le collectif découle de tes forces réelles.",
    type: "zones", champs: [
      ["competences", "Mes compétences (rédaction, prise de parole, réseaux, analyse…)"],
      ["motivations", "Mes motivations et envies"],
      ["limites", "Mes limites et ce que je ne veux pas faire"],
      ["temps", "Mon temps disponible et mes contraintes"]] },
  { id: "fleur", phase: "voir", nom: "Fleur de pouvoir",
    aide: "Identifier ses privilèges et ses biais pour anticiper les rapports de domination dans les rencontres.",
    type: "zones", champs: [
      ["identites", "Mes identités (genre, origine, classe, âge, éducation, santé, langue…)"],
      ["privileges", "Mes privilèges : ce qui facilite mon accès aux décideurs"],
      ["oppressions", "Les discriminations possibles à mon égard, et comment les anticiper collectivement"]] },
  { id: "acteurs", phase: "voir", nom: "Cartographie des acteur·rice·s", type: "special",
    aide: "Position de −2 (opposition forte) à +2 (soutien fort), influence de 0 à 2. Pense à tous les pouvoirs : politique, économique, médiatique, scientifique, citoyen…" },

  // ---------- JUGER ----------
  { id: "tdc", phase: "juger", nom: "Théorie du changement",
    aide: "Schématise le chemin : d'où on part, où on va, par quelles hypothèses. À réévaluer en continu.",
    type: "zones", champs: [
      ["actuelle", "Situation actuelle (constats)"],
      ["visee", "Situation visée (impact espéré)"],
      ["ii", "Impact individuel-interne : transformation personnelle"],
      ["ie", "Impact individuel-externe : transformer les relations"],
      ["ci", "Impact collectif-interne : modèles d'action et de pensée"],
      ["ce", "Impact collectif-externe : structures et procédures"],
      ["hypotheses", "Hypothèses de changement (comment on pense que ça bascule)"],
      ["chemin", "Chemin : activités concrètes → résultats espérés"]] },
  { id: "swot", phase: "juger", nom: "Analyse SWOT",
    aide: "Interne : forces et faiblesses. Externe : opportunités et menaces.",
    type: "zones", grille: true, champs: [
      ["forces", "Forces (interne +)"], ["faiblesses", "Faiblesses (interne −)"],
      ["opportunites", "Opportunités (externe +)"], ["menaces", "Menaces (externe −)"]] },
  { id: "pestel", phase: "juger", nom: "Analyse PESTEL",
    aide: "Balayer le contexte externe, dimension par dimension.",
    type: "zones", grille: true, champs: [
      ["politique", "Politique"], ["economique", "Économique"],
      ["socioculturel", "Socioculturel"], ["technologique", "Technologique"],
      ["environnemental", "Environnemental"], ["legal", "Légal"]] },
  { id: "arbre", phase: "juger", nom: "Arbres à problèmes / objectifs",
    aide: "Racines = causes, tronc = problème, branches = conséquences. Puis tout inverser en positif.",
    type: "zones", champs: [
      ["causes", "🌱 Racines : les causes profondes"],
      ["probleme", "🪵 Tronc : le problème central"],
      ["consequences", "🌿 Branches : les conséquences"],
      ["moyens", "→ Moyens (causes inversées en positif)"],
      ["objectif", "→ Objectif central (problème inversé)"],
      ["resultats", "→ Résultats attendus (conséquences inversées)"]] },
  { id: "pourquoi", phase: "juger", nom: "Les 5 pourquoi", type: "special",
    aide: "Pars du problème visible et creuse : chaque réponse nourrit le pourquoi suivant, jusqu'à la cause racine." },

  // ---------- AGIR ----------
  { id: "pouvoir", phase: "agir", nom: "Avec, sans et contre le pouvoir",
    aide: "Trois dynamiques complémentaires — la plupart des campagnes en combinent plusieurs.",
    type: "zones", champs: [
      ["avec", "AVEC le pouvoir : coopérer avec les institutions (rencontres, avis, concertation)"],
      ["sans", "SANS le pouvoir : alternatives citoyennes autonomes"],
      ["contre", "CONTRE le pouvoir : pression et opposition (manifestation, dénonciation)"]] },
  { id: "smart", phase: "agir", nom: "Objectifs SMART", type: "special",
    aide: "« D'ici (temps), obtenir (décision spécifique et mesurable) en faisant (action atteignable) grâce à (moyen réaliste). » Les échéances alimentent la frise et l'export agenda." },
  { id: "cibles", phase: "agir", nom: "Cibles et alliances",
    aide: "Croiser proximité des positions et niveau d'opposition : collaboration, dialogue, protestation ou confrontation.",
    type: "zones", champs: [
      ["principales", "Cibles principales : qui peut décider le changement ?"],
      ["secondaires", "Cibles secondaires : qui influence les décideurs ?"],
      ["allies", "Alliances : avec qui porter le message, et selon quelle approche ?"]] },
  { id: "message", phase: "agir", nom: "Construire un message", type: "special",
    aide: "Accroche → problème → pourquoi c'est important → cible → action demandée. Clair, simple, relié à l'agenda politique." },
  { id: "rencontre", phase: "agir", nom: "Check-list de rencontre", type: "special",
    aide: "Les 5 étapes clés des manuels, détaillées en points vérifiables." },
  { id: "evaluation", phase: "agir", nom: "Suivi et évaluation",
    aide: "Un processus continu : veilles, cartographie, incidents critiques, données chiffrées.",
    type: "zones", champs: [
      ["indicateurs", "Indicateurs suivis (médias, positions politiques, signatures, incidents…)"],
      ["methodes", "Méthodes : veille médiatique, veille politique, réunions stratégiques…"],
      ["calendrier", "Calendrier d'évaluation (quand fait-on le point ?)"],
      ["lecons", "Leçons apprises et ajustements de stratégie"]] },

  // ---------- ORGANISER ----------
  { id: "kanban", phase: "organiser", nom: "Kanban des tâches", type: "special",
    aide: "À faire → en cours → fait. Glisse les cartes ou utilise les flèches." },
  { id: "frise", phase: "organiser", nom: "Frise chronologique", type: "special",
    aide: "Générée automatiquement depuis les échéances des objectifs SMART et des tâches datées." },
  { id: "journalc", phase: "organiser", nom: "Journal de campagne", type: "special",
    aide: "Consigne rencontres, décisions et rebondissements : la mémoire du collectif." }
];

const PHASES_ATELIER = [
  ["voir", "Voir"], ["juger", "Juger"], ["agir", "Agir"], ["organiser", "Organiser"], ["export", "Exporter"]
];

/* Modèles de projets pré-remplis */
const MODELES = [
  { id: "vierge", nom: "Projet vierge", desc: "Partir d'une page blanche." },
  { id: "cantines", nom: "Cantines durables", desc: "Obtenir du bio et local dans les cantines communales.",
    graine: {
      domino: { vision: "Toutes les écoles communales servent des repas majoritairement bio et locaux, accessibles à tous les enfants." },
      swot: { forces: "Parents mobilisés\nExemples réussis dans d'autres communes", opportunites: "Renouvellement du marché public des cantines\nPlan wallon de transition alimentaire" },
      message: { accroche: "Un repas de cantine sur deux contient des résidus de pesticides.", cible: "le Collège communal", action: "inscrive 50 % de bio et local dans le prochain cahier des charges des cantines" },
      smarts: [{ temps: "", decision: "l'inscription de 50 % de bio/local dans le cahier des charges", action: "une interpellation citoyenne au conseil communal", moyen: "un collectif de parents et l'appui d'une diététicienne", statut: "todo" }]
    } },
  { id: "logement", nom: "Droit au logement", desc: "Lutter contre les logements vides et inabordables.",
    graine: {
      domino: { vision: "Plus aucun bâtiment public laissé vide alors que des personnes cherchent un toit." },
      pestel: { legal: "Droit de gestion publique des logements inoccupés (Code wallon de l'habitation durable)\nTaxe communale sur les immeubles inoccupés" },
      pourquoi: ["Des familles ne trouvent pas de logement abordable", "", "", "", ""]
    } },
  { id: "mobilite", nom: "Mobilité douce", desc: "Sécuriser les trajets à vélo et à pied vers les écoles.",
    graine: {
      domino: { vision: "Chaque enfant peut aller à l'école à pied ou à vélo en sécurité." },
      acteurs: [
        { nom: "Échevin·e de la mobilité", type: "politique", pos: 0, inf: 2, notes: "" },
        { nom: "Association de parents", type: "citoyen", pos: 2, inf: 1, notes: "" },
        { nom: "GRACQ local", type: "citoyen", pos: 2, inf: 1, notes: "" }
      ]
    } }
];
